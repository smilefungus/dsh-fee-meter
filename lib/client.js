...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ── 数据源报表地址 ────────────────────────────────────────────────────
    const FEE_URL = () => { return 'http://10.10.1.21:1023/deepseek?a=' + Math.random(); }
    ...
    const css = [
      ...
      '.fm-panel-close{font:inherit;font-size:18px;line-height:1;color:var(--dsw-alias-label-secondary);background:transparent;border:none;cursor:pointer;padding:4px 8px;border-radius:6px;flex:0 0 auto}',
      '.fm-panel-close:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}',
      ...
      return el(Fragment, null,
        ...
        open ? el('div', { key: 'panel', className: 'fm-panel' },
          el('div', { className: 'fm-panel-head' },
            ...
            el('a', { className: 'fm-panel-link', href: FEE_URL(), target: '_blank', rel: 'noreferrer' }, '新窗口打开'),
            el('button', {
